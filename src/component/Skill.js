...
function BasicRating() {
  ...
  return (
    ...
    >
      <Typography variant='h5' sx={{textDecoration:'underline', width:'35%'}} component={'snap'}>Web DEVELOPMENT SKILL</Typography>
      ...
      <Rating sx={{color: '#008080'}} name="read-only" value={3} readOnly />
      <Typography component="legend">JAVASCRIPT</Typography>
      <Rating sx={{color: '#008080'}} name="disabled" value={4} readOnly />
      <Typography component="legend">React</Typography>
      <Rating sx={{color: '#008080'}} name="no-value" value={3.5}  readOnly/>
      <Typography component="legend">Material UI</Typography>
      <Rating sx={{color: '#008080'}} name="no-value" value={3.1}  readOnly/>
    ...
    >
      <Typography variant='h5' sx={{textDecoration:'underline', width:'35%'}} component={'snap'}>Relevant Course-Work</Typography>
      ...
      <Rating sx={{color: '#008080'}} name="read-only" value={4} readOnly />
      <Typography component="legend">CPP</Typography>
      <Rating sx={{color: '#008080'}} name="CPP" value={4} readOnly />
      <Typography component="legend">Operating System</Typography>
      <Rating sx={{color: '#008080'}} name="no-value" value={3}  readOnly/>
